...
export interface ApiCajeraCajera extends Struct.CollectionTypeSchema {
  collectionName: 'cajeras';
  info: {
    description: 'Cajeras de la sucursal';
    displayName: 'Cajera';
    pluralName: 'cajeras';
    singularName: 'cajera';
  };
  ...
  attributes: {
    ...
    turnos: Schema.Attribute.Relation<'oneToMany', 'api::turno.turno'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOrdenOrden extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u00D3rdenes de productos para retiro';
    displayName: 'Orden';
    pluralName: 'ordenes';
    singularName: 'orden';
  };
  ...
  attributes: {
    ...
    estado: Schema.Attribute.Enumeration<
      ['pendiente', 'preparado', 'retirado', 'cancelado']
    > &
      Schema.Attribute.DefaultTo<'pendiente'>;
    fechaCreacion: Schema.Attribute.DateTime & Schema.Attribute.Required;
    fechaPreparacion: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::orden.orden'> &
      Schema.Attribute.Private;
    notas: Schema.Attribute.Text;
    numeroOrden: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
...
export interface ApiPublicidadPublicidad extends Struct.CollectionTypeSchema {
  collectionName: 'publicidades';
  info: {
    description: 'Publicidades para mostrar en pantalla TV';
...
export interface ApiSucursalSucursal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activa: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    cajeras: Schema.Attribute.Relation<'oneToMany', 'api::cajera.cajera'>;
    codigo: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    createdAt: Schema.Attribute.DateTime;
    ...
    tiempoPromedioAtencion: Schema.Attribute.Float &
      Schema.Attribute.DefaultTo<5>;
    turnoActual: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    turnos: Schema.Attribute.Relation<'oneToMany', 'api::turno.turno'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTurnoTurno extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Gesti\u00F3n de turnos en la fila';
    displayName: 'Turno';
    pluralName: 'turnos';
    singularName: 'turno';
  };
  ...
  attributes: {
    cajera: Schema.Attribute.Relation<'manyToOne', 'api::cajera.cajera'>;
    cliente: Schema.Attribute.Relation<'manyToOne', 'api::cliente.cliente'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estado: Schema.Attribute.Enumeration<
      ['pendiente', 'en-atencion', 'atendido', 'ausente']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'pendiente'>;
    fechaCreacion: Schema.Attribute.DateTime & Schema.Attribute.Required;
    fechaFinAtencion: Schema.Attribute.DateTime;
    fechaInicioAtencion: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::turno.turno'> &
      Schema.Attribute.Private;
    notificado10Numeros: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    numero: Schema.Attribute.Integer & Schema.Attribute.Required;
    ordenId: Schema.Attribute.String;
    posicionEnFila: Schema.Attribute.Integer & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    sucursal: Schema.Attribute.Relation<'manyToOne', 'api::sucursal.sucursal'>;
    tiempoEstimado: Schema.Attribute.Integer;
    tiempoPromedioAtencion: Schema.Attribute.Float;
    tipo: Schema.Attribute.Enumeration<['retiro', 'compra', 'devolucion']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiUsuarioUsuario extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cajera: Schema.Attribute.Relation<'oneToOne', 'api::cajera.cajera'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email &
    ...
    rol: Schema.Attribute.Enumeration<
      ['jefe_general', 'jefe_sucursal', 'cajera']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'cajera'>;
    sucursal: Schema.Attribute.Relation<'manyToOne', 'api::sucursal.sucursal'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::cajera.cajera': ApiCajeraCajera;
